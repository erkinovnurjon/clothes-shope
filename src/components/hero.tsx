...
const Hero  = () => {
  return (
    <section className='text-gray-600 body-font'>
      <div className='container mx-auto flex px-5 pb-20 md:flex-row flex-col items-center'>
        ...
        <div className='lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center'>
          ...
          <div className='flex w-full md:justify-start justify-center items-end'>
            ...
            <button className='inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg transition-colors duration-200 ease-in-out'>
              Button
            </button>
          </div>
          ...
          <div className='flex lg:flex-row md:flex-col'>
            ...
            <button className='bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center lg-ml-4 md-ml-0 ml-4 md-mt-4 mt-0 lg-mt-0 hover-bg-gray-200 focus-outline-none'>
              ...
              >
                ...
                <path d='M212.1 0c-15.76.64-34.67 10.35-45.97 23.58-9.6 11.13-19 29.68-16.52 48.38a2.5 2.5 0 002.29 2.17c-18-26.37-45.62-30.34-56.73-30.82a50.04 50.04 0 00-4.95-.24c-13.06 0-25.56 4.93-35.61 8.9-6.94 2.73-12.93 5.09-17.06 5.09-4.64 0-10.67-2.4-17.65-5.16-9.33-3.7-19.9-7.9-31.1-7.9l-.79.01c-26.03.38-50.62 15.27-64.18 38.86z'></path>
              </svg>
              <span className='ml-4 flex items-start flex-col leading-none'>
                <span className='text-xs text-gray-600 mb-1'>
                  Download on the
